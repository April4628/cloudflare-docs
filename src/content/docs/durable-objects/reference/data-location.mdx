...
:::caution
Currently, SQLite-backed Durable Objects does not support FedRAMP jurisdiction (regardless of whether you use KV storage API or SQL API). If you require Durable Objects which support with FedRAMP jurisdiction, use regular Durable Objects.
:::
